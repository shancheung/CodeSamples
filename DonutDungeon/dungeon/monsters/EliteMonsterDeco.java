...
public class EliteMonsterDeco extends MonsterDecorator {
    
    public EliteMonsterDeco(Monster monster) {
        super(monster);
    }
    
    @Override
    public String monsterName() {
        return "Elite " + monster.monsterName();
    }
    ...
    public void setStats() {
        ...
        if (monName == "Donut") {
            ...
            statsList.add(20);   //Defense
            statsList.add(35);   //Hp
            statsList.add(18);   //Dodge
            statsList.add(25);   //Speed
        } else if (monName == "Braverian Creme") {
            statsList.add(27);   //Strength
            statsList.add(20);   //Defense
            statsList.add(45);   //Hp
            statsList.add(20);   //Dodge
            statsList.add(27);   //Speed
        } else if (monName == "Apfelkrapfen Hase") {
            statsList.add(35);   //Strength
            statsList.add(28);   //Defense
            statsList.add(60);   //Hp
            statsList.add(25);   //Dodge
            statsList.add(32);   //Speed
        }
    }
}
